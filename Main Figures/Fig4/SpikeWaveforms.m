%%This code compute and store the average spike waveform of the given unit. This waveforms were used to compute similarity scores
...
%     eeg = eegmatrix(2:end,(eegmatrix(1,:) == channel)); 
    ...
    subplot(1,4,kh)
    hold on
    plot(wfmatrix,'Color',[0.7,0.7,0.7,0.1]);
    plot(mean(wfmatrix,2),'b');
    kh = kh+1;
    end
